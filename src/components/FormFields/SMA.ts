export const SpecialMessageActionGeneralType = {};

interface SMADefinition {
  description: string;
  properties: {
    type: {
      enum: string[];
...
export const SpecialMessageActions: { [name: string]: SMADefinition } = {
  ...
  SAVE_WITH_POCKET: {
    description: "Saves current page to pocket.",
    properties: {
      type: {
        enum: ["SAVE_WITH_POCKET"],
        type: "string",
      },
    },
    type: "object",
